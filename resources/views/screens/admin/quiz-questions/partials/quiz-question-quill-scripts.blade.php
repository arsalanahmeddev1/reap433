@push('styles')
    ...
    <style>
        .quiz-question-quill-wrap .ql-toolbar {
            border: 1px solid rgba(255, 255, 255, 0.12);
            border-bottom: none;
            border-radius: 0.25rem 0.25rem 0 0;
            background: #1a1a1a;
        }
        .quiz-question-quill-wrap .ql-container {
            border: 1px solid rgba(255, 255, 255, 0.12);
        ...
        .quiz-question-quill-wrap .ql-editor {
            min-height: 200px;
        }
        .quiz-question-quill-wrap .ql-editor.ql-blank::before {
            color: rgba(248, 244, 237, 0.45);
        }
        .quiz-question-quill-wrap .ql-editor img {
            max-width: 100%;
            height: auto;
        }
        .quiz-question-quill-wrap .ql-stroke {
            stroke: #f8f4ed;
        }
        .quiz-question-quill-wrap .ql-fill {
            fill: #f8f4ed;
        }
        .quiz-question-quill-wrap .ql-picker-label {
            color: #f8f4ed;
        }
    </style>
@endpush
...
@push('scripts')
    ...
    <script>
        (function() {
            ...
            window.quizQuestionQuillEditors = {
                create: null,
                edit: null,
            };
            ...
            window.syncQuizQuestionQuill = function(quill, textareaId) {
            ...
            window.setQuizQuestionQuillContent = function(quill, html) {
                if (!quill) {
                    return;
                }
                if (html && html.trim() !== '') {
            ...
            function uploadAndInsertImage(quill, textareaId, file) {
                ...
                fetch(uploadUrl, {
                    ...
                    .then(function(result) {
                        ...
                        syncQuizQuestionQuill(quill, textareaId);
                    })
                    .catch(function() {
                        if (loading && typeof Swal !== 'undefined') {
                            Swal.close();
            ...
            function createQuizQuestionQuill(hostSelector, textareaId) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                window.quizQuestionQuillEditors.create = createQuizQuestionQuill(
                    '#qq_create_description_editor',
                    'qq-create-description'
                );
                window.quizQuestionQuillEditors.edit = createQuizQuestionQuill(
                    '#qq_edit_description_editor',
                    'qq-edit-description'
                );
                ...
                document.addEventListener(
                    ...
                    function(e) {
                        ...
                        if (t.id === 'quiz-question-create-form' && window.quizQuestionQuillEditors.create) {
                            syncQuizQuestionQuill(window.quizQuestionQuillEditors.create, 'qq-create-description');
                        }
                        if (t.id === 'quiz-question-edit-form' && window.quizQuestionQuillEditors.edit) {
