@push('styles')
    ...
    <style>
        .quiz-category-quill-wrap .ql-toolbar {
            border: 1px solid rgba(255, 255, 255, 0.12);
            border-bottom: none;
            border-radius: 0.25rem 0.25rem 0 0;
            background: #1a1a1a;
        }
        .quiz-category-quill-wrap .ql-container {
            border: 1px solid rgba(255, 255, 255, 0.12);
        ...
        .quiz-category-quill-wrap .ql-editor {
            min-height: 200px;
        }
        .quiz-category-quill-wrap .ql-editor.ql-blank::before {
            color: rgba(248, 244, 237, 0.45);
        }
        .quiz-category-quill-wrap .ql-editor img {
            max-width: 100%;
            height: auto;
        }
        .quiz-category-quill-wrap .ql-stroke {
            stroke: #f8f4ed;
        }
        .quiz-category-quill-wrap .ql-fill {
            fill: #f8f4ed;
        }
        .quiz-category-quill-wrap .ql-picker-label {
            color: #f8f4ed;
        }
    </style>
@endpush
...
@push('scripts')
    ...
    <script>
        (function() {
            ...
            window.quizCategoryQuillEditors = {
                create: null,
                edit: null,
            };
            ...
            window.syncQuizCategoryQuill = function(quill, textareaId) {
            ...
            window.setQuizCategoryQuillContent = function(quill, html) {
                if (!quill) {
                    return;
                }
                if (html && html.trim() !== '') {
            ...
            function uploadAndInsertImage(quill, textareaId, file) {
                ...
                fetch(uploadUrl, {
                    ...
                    .then(function(result) {
                        ...
                        syncQuizCategoryQuill(quill, textareaId);
                    })
                    .catch(function() {
                        if (loading && typeof Swal !== 'undefined') {
                            Swal.close();
            ...
            function createQuizCategoryQuill(hostSelector, textareaId) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                window.quizCategoryQuillEditors.create = createQuizCategoryQuill(
                    '#qc_create_description_editor',
                    'qc-create-description'
                );
                window.quizCategoryQuillEditors.edit = createQuizCategoryQuill(
                    '#qc_edit_description_editor',
                    'qc-edit-description'
                );
                ...
                document.addEventListener(
                    ...
                    function(e) {
                        ...
                        if (t.id === 'quiz-category-create-form' && window.quizCategoryQuillEditors.create) {
                            syncQuizCategoryQuill(window.quizCategoryQuillEditors.create, 'qc-create-description');
                        }
                        if (t.id === 'quiz-category-edit-form' && window.quizCategoryQuillEditors.edit) {
