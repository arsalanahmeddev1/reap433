...
Route::middleware('guest')->group(function () {
    ...
    Route::get('register/wholesaler', [RegisteredUserController::class, 'createWholeSeller'])
        ->name('register.wholesaler');

    Route::post('register/wholesaler', [RegisteredUserController::class, 'storeWholeSeller'])
